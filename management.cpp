...
#include<dos.h>        //for delay and sleep function
      ...
      void entry()
		...
		clrscr();
		gotoxy(32,4);
		puts("S.T.A.R COMPUTERS");
		gotoxy(5,8);
		puts("Customer ID :");
		gotoxy(5,10);
		puts("Customer name :");
		gotoxy(5,12);
		puts("Customer adress :");
		gotoxy(5,14);
		puts("Customer Service number :");
		gotoxy(5,16);
		puts("Costumer Smart card number :");
		gotoxy(5,18);
		puts("Costumer Phone number :");
		gotoxy(5,20);
		puts("Customer Bill number :");
		gotoxy(45,8);
		cin>>cno;
		gotoxy(45,10);
		gets(cname);
	...
	void main()
		...
		unsigned int sum,add,d,j,e,f,g,h,k=0,l,w,x,y,z,choice;
	...
	cout<<"\t\t\t\tTO MANAGE \n\n\n";
	cout<<"\t\t\t\tTHEIR SHOP   \n\n\n";
	cout<<"\t\t\t  AND TO KEEP THEIR RECORDS  \n\n\n";
	cout<<"\t   IN A ORDERED WAY SO AS TO ENSURE PRECISION  \n\n\n";
	getch();
	clrscr();
	cout<<"\n\n\n\n\n\n\n\n\t\t\t\t WELCOME\n\n";
	cout<<"\t\t\t\t   TO\n\n";
	...
	clrscr();
	pass:;
	cout<<"\n\n\tPLEASE BE CAREFUL ENTER THE IN SMALL LETTERS\n";
	...
	clrscr();
	gotoxy(1,6);
	 puts("                          COMPUTER SCIENCE PROJECT WORK                         \n");
	puts("                                                                                \n");
	puts("********************************************************************************");
	cout<<"\n";
	puts ("                         WELCOME TO THE S.T.A.R COMPUTERS                       \n");
	puts("********************************************************************************\n");
	puts("********************************************************************************\n");
	gotoxy(2,21);
	 puts("                    G.D. GOENKA PUBLIC SCHOOL                   ");
	 gotoxy(2,22);
	 puts("                   VASANT KUNJ, NEW DELHI                             ");
	 cout<<"\n";
	puts("********************************************************************************\n");
	puts("********************************************************************************\n");
	gotoxy(1,29);
	...
	puts("********************************************************************************\n");
	gotoxy(1,37);
	 puts("                 BY:- Varun Jain And Vishesh Tandon                             \n");
	 gotoxy(1,39);
	 puts("                                       Class XII - B                              \n");
	 gotoxy(1,41);
	 puts("                                       9172173 and 9172169                              \n");
	 gotoxy(1,43);
	 puts("                              YEAR:- 2013-2014                                 \n");
	 cout<<"\n\n";
	puts("********************************************************************************\n");
	...
	gotoxy(25,10);
	puts("WELCOME TO THE WORLD OF COMPUTERS .");
	gotoxy(5,15);
	puts("THIS PROJECT CONTAINS SOME ITEMS AND SIMPLE THING YOU HAVE TO DO IS:-");
	gotoxy(5,17);
	puts("ENTER THE NAME , CUSTOMER ID , SERIAL NUMBER , SMART CARD NUMBER etc.");
	gotoxy(5,19);
	puts("THEN PURCHASE THE ITEMS AND REMEMBER THE QUANTITY ITEMS CARRY.");
	gotoxy(5,21);
	puts("YOU CAN ALSO MODIFY , DELETE , SEARCH A RECORD.");
	gotoxy(5,23);
	puts("YOU CAN ALSO ALL RECORDS YOU HAVE ENTERED IN YOUR COMPUTER.");
	gotoxy(5,25);
	puts("BUT DO NOT EXPECT FOR ANY DISCOUNT.");
	gotoxy(5,27);
	puts("WE HOPE THAT YOU WILL BE SATISFIED WITH OUR SERVICE.");
	gotoxy(5,29);
	puts("WE ARE NOT RESPONSIBLE FOR ANY DEFECT IN THE PRODUCT YOU PURCHASE.");
	getch();
	clrscr();
